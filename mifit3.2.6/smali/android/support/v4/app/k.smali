...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/u;
    ...
    .prologue
    .line 304
    iget-object v0, p0, Landroid/support/v4/app/k;->f:Landroid/support/v4/f/m;
    ...
    iput-object v0, p0, Landroid/support/v4/app/k;->f:Landroid/support/v4/f/m;
    ...
    .line 310
    iget-object v1, p0, Landroid/support/v4/app/k;->f:Landroid/support/v4/f/m;
...
.method a(Landroid/support/v4/f/m;)V
    ...
    .line 354
    invoke-virtual {p1, v1}, Landroid/support/v4/f/m;->c(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/u;

    invoke-virtual {v0, p0}, Landroid/support/v4/app/u;->a(Landroid/support/v4/app/k;)V
    ...
    .line 357
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/k;->f:Landroid/support/v4/f/m;
...
.method a(Z)V
    ...
    .line 258
    iget-object v0, p0, Landroid/support/v4/app/k;->h:Landroid/support/v4/app/u;
...
.method l()Landroid/support/v4/app/u;
    .locals 3
    ...
    .line 213
    :cond_0
    iput-boolean v2, p0, Landroid/support/v4/app/k;->i:Z
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/k;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/u;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/k;->h:Landroid/support/v4/app/u;
...
.method q()Landroid/support/v4/f/m;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 327
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/k;->m()Z
    ...
    .line 330
    iget-boolean v6, v5, Landroid/support/v4/app/u;->f:Z
    ...
    .line 331
    iget-boolean v6, v5, Landroid/support/v4/app/u;->e:Z

    if-nez v6, :cond_1

    .line 332
    invoke-virtual {v5}, Landroid/support/v4/app/u;->b()V

    .line 334
    :cond_1
    invoke-virtual {v5}, Landroid/support/v4/app/u;->d()V
    ...
    .line 339
    :cond_3
    invoke-virtual {v5}, Landroid/support/v4/app/u;->h()V

    .line 340
    iget-object v6, p0, Landroid/support/v4/app/k;->f:Landroid/support/v4/f/m;

    iget-object v5, v5, Landroid/support/v4/app/u;->d:Ljava/lang/String;

    invoke-virtual {v6, v5}, Landroid/support/v4/f/m;->remove(Ljava/lang/Object;)Ljava/lang/Object;
